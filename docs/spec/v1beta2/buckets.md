...
```sh
kubectl get events --field-selector involvedObject.kind=Bucket,involvedObject.name=minio-bucket
```
...
2m30s       Normal    BucketOperationSucceed       bucket/minio-bucket   downloaded 16 files with revision 'e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855' from 'my-minio-bucket'
2m30s       Normal    NewArtifact                  bucket/minio-bucket   stored artifact for revision 'e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855'
18s         Warning   BucketOperationFailed        bucket/minio-bucket   bucket 'my-new-bucket' does not exist
```

Besides being reported in Events, the reconciliation errors are also logged by
the controller. The Flux CLI offer commands for filtering the logs for a
specific Bucket, e.g. `flux logs --level=error --kind=Bucket --name=minio-bucket`.
...
A Bucket enters various states during its lifecycle, reflected as [Kubernetes
...
The Bucket API is compatible with the [kstatus
