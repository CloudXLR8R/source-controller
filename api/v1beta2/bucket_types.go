...
type BucketSpec struct {
	...
	// Timeout for fetch operations, defaults to 20s.
...
type BucketStatus struct {
	...
	// URL is the dynamic download link for the latest Artifact.
...
const (
	// BucketOperationSucceedReason signals that the Bucket listing and fetch
